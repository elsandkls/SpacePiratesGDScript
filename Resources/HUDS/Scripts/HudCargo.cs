...
public partial class HudCargo : Node2D
{   
 
    public int hud_value = 100;
    private int debug = 0;
 
    private string ClassName = "HudCargo";
    ...
    public override void _Ready()
    {
        ...
        Hundreds_AnimatedSprite2D = GetNode<AnimatedSprite2D>("VBoxContainer/HBoxContainer2/BoxContainer/Hundreds_AnimatedSprite2D"); 
        Tens_AnimatedSprite2D = GetNode<AnimatedSprite2D>("VBoxContainer/HBoxContainer2/BoxContainer2/Tens_AnimatedSprite2D");  
        Ones_AnimatedSprite2D = GetNode<AnimatedSprite2D>("VBoxContainer/HBoxContainer2/BoxContainer3/Ones_AnimatedSprite2D");  
        TextureProgressBar TextureProgressBar_Energy = GetNode<TextureProgressBar>("TextureProgressBar_Energy"); 
        TextureProgressBar TextureProgressBar_Damage = GetNode<TextureProgressBar>("TextureProgressBar_Damage"); 
    }
